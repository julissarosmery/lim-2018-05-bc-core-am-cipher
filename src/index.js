let resultCifred = () => {//se crea la function del boton resultado de cifrad
    ...
    let result = cipher.encode(posicion,tex);//se obtiene el elemento con el id =respuesta del texarea=area de texto ..para grabar el resultado..//y se le llama del html y vincula la formula de encode =codificar insertandola en tex y posicion
...
let resultDecifre = () => {//se crea la function del boton resultado de decifrar
    ...
    ////console.log(posicion); //para que tambien aparesca en la consola
    let r =cipher.decode(posicion,tex);//se obtiene el elemento con el id =respuesta del texarea=area de texto ..para grabar el resultado   //y se le llama del html y vincula la formula de decode =codificar insertandola en tex y posicion 
